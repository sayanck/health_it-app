package com.healthit.application.ui.videoCall
...
class VideoCallActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (checkSelfPermission(Manifest.permission.RECORD_AUDIO,
                PERMISSION_REQ_ID_RECORD_AUDIO) && checkSelfPermission(
    ...
    fun onLocalVideoMuteClicked(view: View) {
        ...
        if (iv.isSelected) {
            ...
            iv.isSelected = true
            iv.setColorFilter(resources.getColor(R.color.purple), PorterDuff.Mode.MULTIPLY)
        }
